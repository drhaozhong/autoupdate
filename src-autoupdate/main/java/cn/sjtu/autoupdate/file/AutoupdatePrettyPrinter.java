...
import cn.sjtu.autoupdate.file.PrintingContext.Writable;
...
public class AutoupdatePrettyPrinter implements CtVisitor, PrettyPrinter {
	 ...
	 */
	public AutoupdatePrettyPrinter(Environment env) {
		this.env = env;
	 ...
	 */
	public AutoupdatePrettyPrinter setLineSeparator(String lineSeparator) {
	...
	protected void enterCtExpression(CtExpression<?> e) {
		...
		if (!e.getTypeCasts().isEmpty()) {
			for (CtTypeReference<?> r : e.getTypeCasts()) {
				printer.writeSeparator("(");
				AutoupdatePrettyPrinter.this.scan(r);
	 ...
	 */
	public AutoupdatePrettyPrinter scan(CtElement e) {
		if (e != null) {
			enter(e);
	 ...
	 */
	public AutoupdatePrettyPrinter writeHeader(List<CtType<?>> types, Collection<CtImport> imports) {
	 ...
	 */
	public AutoupdatePrettyPrinter writeFooter(List<CtType<?>> types) {
	...
	/**
	 * @return current {@link TokenWriter}, so the subclasses of {@link AutoupdatePrettyPrinter} can print tokens too
	 */
	 ...
	 */
	public AutoupdatePrettyPrinter setPrinterTokenWriter(TokenWriter tokenWriter) {

...
public class ProgramVariant {
	 ...
	 * variant.
	 */
	protected Map<String, CtType> loadClasses = new HashMap<String, CtType>();
	 ...
	 */
	protected List<CtType> modifiedClasses = new ArrayList<CtType>();
	...
	public Map<String, CtType> getBuiltClasses() {
		return loadClasses;
	}
	...
	public String toString() {
		return "[Variant id: " + this.id + (this.isSolution() ? " (SOL) " : "") + " fit:" + this.fitness+", #gens: "
	...
	public List<CtType<?>> getAffectedClasses() {
		...
		for (CtType c : loadClasses.values()) {
			r.add(c);
		}
	...
	public List<CtType> getModifiedClasses() {
		return modifiedClasses;
	}

	public void setModifiedClasses(List<CtType> resultedClasses) {
	...
	public void clearModificationPoints() {

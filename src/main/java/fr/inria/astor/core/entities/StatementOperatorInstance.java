...
public class StatementOperatorInstance extends OperatorInstance {
	...
	public StatementOperatorInstance(ModificationPoint modificationPoint, AstorOperator operationApplied,
			CtElement original, CtElement modified, String mapping) {
		super(modificationPoint, operationApplied, original, modified, mapping);
...
//			CtElement modified, String mapping) {
//		this(modificationPoint, nullPreconditionOperator, modificationPoint.getCodeElement(), mapping);
//	}

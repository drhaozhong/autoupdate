...
public class InvocationResolver {
	...
	public static boolean fitImplicitInvocation(CtType ctClassMP, CtAbstractInvocation inv0) {
	...
	@SuppressWarnings("rawtypes")
	public static InvocationMatching mapImplicitInvocation(CtType ctClassMP, CtAbstractInvocation inv0) {

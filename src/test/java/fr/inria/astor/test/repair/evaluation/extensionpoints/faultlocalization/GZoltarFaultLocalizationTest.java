...
public class GZoltarFaultLocalizationTest {
	...
	public void testCoverageMath70() throws Exception {
		...
		for (ModificationPoint mp : pv.getModificationPoints()) {
			...
			if(smp.getSuspicious() instanceof SuspiciousTestedCode) {
				SuspiciousTestedCode stc = (SuspiciousTestedCode)smp.getSuspicious();
				List<TestCaseResult> coverage = stc.getCoveredByTests();
	...
	public void testParseLine() {
		...
		SuspiciousTestedCode sc = fl.parseLine(line);
	...
	public void testFLCM() throws Exception {
		...
		List<SuspiciousTestedCode> susp = flr.getCandidates();
